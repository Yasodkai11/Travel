...
export function PlaceCard({ name, description, image }: PlaceCardProps) {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow h-full flex flex-col">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <button className="mt-4 text-secondary font-semibold hover:text-primary text-sm uppercase tracking-wide self-start">
          Explore &rarr;
        </button>
      </div>
    </div>
